#' SESplot
#' 
#' To draw relevant chart of a 'ses-class' object (generated by importSES) 
...
#' SESplot.ses
#' 
#' \code{SESplot()} with regular 'ses' objects.
#' 
...
#' SESplot.statdives
#' 
#' \code{SESplot()} with regular 'statdives' objects.
#' 
#' @inheritParams SESplot
...
#' SESplot.tdr
#' 
#' A method for \code{SESplot()} with tdr objects.
#' 
