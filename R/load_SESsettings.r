...
if (inherits(get("formatSES", envir=SESsettings), "try-error")){
	...
	assign("formatSES", structure(list(tdr = structure(list(userAlias = c("Time", "Depth", 
																		  ...
																		  "Catch.id", "Day.id", "Dive.id", "Dive.type", "Dive.step"), suggestedAlias = c("Time", 
																		  			...
																		  			), applyFun = c("datenum2posx", "as.double", "as.double", "as.double", 
																		  							"as.logical", "as.logical", "as.logical", "as.integer", "as.integer", 
																		  							"as.integer", "as.integer", "as.integer", "as.integer")), .Names = c("userAlias", 
																		  																								 "suggestedAlias", "keep", "description", "applyFun"), class = c("fmtSES", 
																		  																								 																"data.frame"), row.names = c("ptimes_num", "corrected_depth", 
																		  																								 																							 "external_temperature", "ligth_level", "capture", "captureX", 
																		  																								 																							 "captureY", "captureZ", "num_evts", "no_jour", "no_dive", "type_dive", 
																		  																								 																							 "phase_dive")), stat = structure(list(userAlias = c("Dive.id", 
																		  																								 																							 													...
																		  																								 																							 													"Lon", "Angle.desc", "Angle.asc", "IR150", "T200m"), suggestedAlias = c("Dive.id", 
																		  																								 																							 																															...
																		  																								 																							 																															"Lon", "Angle.desc", "Angle.asc", "IR150", "T200m"), keep = c(TRUE, 
																		  																								 																							 																																														  ...
																		  																								 																							 																																														  FALSE), description = c("Dive number", "Time when dive started (matlab numeric format)", 
																		  																								 																							 																																														  						"Line number of dive start in TDR dataset", "Dive duration (s)", 
																		  																								 																							 																																														  						...
																		  																								 																							 																																														  						"Temperature at 200 m (C deg.)"), applyFun = c("as.integer", 
																		  																								 																							 																																														  																	   "datenum2posx", "as.integer", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  																	   "as.double", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  																	   "as.double", "as.double", "as.integer", "as.character", "as.double", 
																		  																								 																							 																																														  																	   "as.integer", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  																	   "as.double", "as.double", "as.logical", "as.double", "as.double", 
																		  																								 																							 																																														  																	   "as.double", "as.double", "as.double", "as.double", "as.double"
																		  																								 																							 																																														  						)), .Names = c("userAlias", "suggestedAlias", "keep", "description", 
																		  																								 																							 																																														  									   "applyFun"), class = c("fmtSES", "data.frame"), row.names = c("dive_numb", 
																		  																								 																							 																																														  									   															  ...
																		  																								 																							 																																														  									   															  "temp200m")), tdr3D = structure(list(userAlias = c("Time", "Distance", 
																		  																								 																							 																																														  									   															  												   ...
																		  																								 																							 																																														  									   															  												   "var3", "var4"), suggestedAlias = c("Time", "Distance", "Lat.rad", 
																		  																								 																							 																																														  									   															  												   			...
																		  																								 																							 																																														  									   															  												   			FALSE, FALSE, FALSE), description = c("Date and time (matlab numeric format)", 
																		  																								 																							 																																														  									   															  												   												  ...
																		  																								 																							 																																														  									   															  												   												  "Depth (m)", "???", "???", "???", "???"), applyFun = c("datenum2posx", 
																		  																								 																							 																																														  									   															  												   												  													   "as.double", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  									   															  												   												  													   "as.double", "as.double", "as.double", "as.double", "as.double"
																		  																								 																							 																																														  									   															  												   												  )), .Names = c("userAlias", "suggestedAlias", "keep", "description", 
																		  																								 																							 																																														  									   															  												   												  			   "applyFun"), class = c("fmtSES", "data.frame"), row.names = c("DateTime", 
																		  																								 																							 																																														  									   															  												   												  			   															  "Distance", "LatRad", "LongRad", "Latitude", "Longitude", "Depth", 
																		  																								 																							 																																														  									   															  												   												  			   															  "DRCalcSpd", "NewX", "NewY", "Bering")), stat3D = structure(list(
																		  																								 																							 																																														  									   															  												   												  			   															  	userAlias = c("Dive.dur", "Desc.dur", "Bott.dur", "Asc.dur", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  "Surfi.dur", "Surff.dur", "Depth.max", "Dist.h", "Angle.desc", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  "Angle.asc", "Sinuosity.h", "Sinuosity.v", "varinconnue1", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  "varinconnue2", "varinconnue3", "varinconnnue4", "Effort.desc", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  "Effort.bott", "Effort.asc", "Catch.numb.bott", "Direction", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  "Speed", "Speed.current", "Direction.current", "is.diveGeoref", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  "Dist.gps", "Dist.model", "Dist.diff"), suggestedAlias = c("Dive.dur", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   ...
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   "Catch.numb.bott", "Direction", "Speed", "Speed.current", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   "Direction.current", "is.diveGeoref", "Dist.gps", "Dist.model", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   "Dist.diff"), keep = c(TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   TRUE, TRUE), description = c("Duration of dive (s)", "Duration of the descent step of the dive (s)", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   							 "Duration of the bottom step (s)", "Duration of the ascent step (s)", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   ...
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   ), applyFun = c("as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   				"as.double", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   				"as.double", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   				"as.double", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   				"as.integer", "as.double", "as.double", "as.double", "as.double", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   				"as.logical", "as.double", "as.double", "as.double")), .Names = c("userAlias", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   																				  "suggestedAlias", "keep", "description", "applyFun"), class = c("fmtSES", 
																		  																								 																							 																																														  									   															  												   												  			   															  				  														   					   																				  																"data.frame"), row.names = c("diveduration", "desc_duration", 
