...
#' SESplot
#' @description To draw relevant chart of a ses object.
...
#' SESplot.ses
#' @description A method for \code{SESplot()} with regular ses objects
#' @param ses An ses object (generated by importSES).
#' @param pch Plotting character.
#' @param cex Plotting character size.
#' @param fill Should the terrestrial area be filled with color.
...
#' SESplot.tdr3D
#' @description A method for \code{SESplot()} with tdr3D objects
#' @param ses An tdr3D object (generated by importSES).
#' @param pch Plotting character.
#' @param cex Plotting character size.
#' @param Z A 'statdives' variable to plot along the trajectory.
#' @param Z.col Colors for Z values.
