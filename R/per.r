#' per
#' @description The reverse of 'base::rep()' function: decompose an atomic vector to its successive values and their length.
...
#' @return A data frame with values and lengths of the homogeneous sequences of x. The class of the column 'value' is copied from the input.
#' @author Yves
#' @export
#' @examples
